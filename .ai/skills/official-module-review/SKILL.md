...
description: Review a finished official module diff against approved requirements and executable regression evidence, then record an exact-source release review.
---
