...
description: Test official module behavior against its acceptance scenarios, tenant and permission boundaries, PostgreSQL adapters and a real SDK consumer.
---
